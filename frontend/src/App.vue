...
import { Activity, AlertTriangle, Bot, CheckCircle2, ChevronRight, CloudCog, Gauge, Loader, LockKeyhole, RefreshCw, Rocket, Settings2, ShieldAlert, Terminal, Zap } from 'lucide-vue-next'
